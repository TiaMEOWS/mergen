...
Automated CIS benchmark audit skills for Mergen. Each skill maps to a single CIS control with audit procedures, remediation steps, and compliance mappings.
