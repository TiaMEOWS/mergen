# CIS Apache Tomcat 8 Benchmark v1.0.0 - Mergen Skills

This directory contains **61 CIS benchmark controls** for Apache Tomcat 8, organized as Mergen SKILL.md files.
...
Each control is implemented as a Mergen skill that can be invoked during security assessments:

```bash
mergen run /cis-tomcat8-v100-1.1
mergen run /cis-tomcat8-v100-4.1
```
