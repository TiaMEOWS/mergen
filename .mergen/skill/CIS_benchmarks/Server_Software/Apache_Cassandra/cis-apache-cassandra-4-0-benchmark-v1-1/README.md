...
These skills can be used with the Mergen platform to perform automated security assessments of Apache Cassandra 4.0 installations against CIS Benchmark requirements.
