...
mergen run skill cis-cassandra41-1.1

# Run all Cassandra CIS controls
mergen run skill cis-cassandra41-*

# Run only automated controls
mergen run skill cis-cassandra41-1.2 cis-cassandra41-1.3 cis-cassandra41-1.4 cis-cassandra41-1.5 cis-cassandra41-2.1 cis-cassandra41-2.2 cis-cassandra41-3.1 cis-cassandra41-3.2 cis-cassandra41-3.4 cis-cassandra41-4.1 cis-cassandra41-5.1 cis-cassandra41-5.2
```
...
AGPL-3.0-only + Commercial Licensing (contact@mergen.dev)
