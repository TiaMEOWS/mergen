...
This directory contains Mergen skills for CIS AWS Storage Services Benchmark v1.0.0, Section 1 (AWS Backup) and Section 2 (EBS) controls.
...
These skills can be used in Mergen for:
