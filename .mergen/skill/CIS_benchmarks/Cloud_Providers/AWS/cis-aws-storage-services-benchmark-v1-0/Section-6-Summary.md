...
These skills can be invoked in Mergen to audit AWS EDR configurations:

```bash
# Audit all Section 6 controls
mergen run "Audit CIS AWS Storage Section 6 controls"

# Audit specific control
mergen run "Check CIS 6.1 - EDR Configuration"

# Remediate specific control
mergen run "Remediate CIS 6.5 - IAM for EDR"
```
