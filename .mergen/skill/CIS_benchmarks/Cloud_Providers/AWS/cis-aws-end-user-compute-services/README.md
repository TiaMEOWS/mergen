...
This directory contains Mergen skills for the CIS AWS End User Compute Services Benchmark v1.2.0.
...
Each skill can be invoked individually via Mergen CLI:

```bash
mergen run cis-aws-euc-4.1  # WorkDocs IAM admin control
mergen run cis-aws-euc-5.1  # AppStream VPC control
```
