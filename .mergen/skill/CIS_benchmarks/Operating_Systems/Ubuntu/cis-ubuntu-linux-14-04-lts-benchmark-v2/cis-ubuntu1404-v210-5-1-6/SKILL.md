---
name: "CIS Ubuntu 14.04 LTS - 5.1.6 Ensure permissions on /etc/cron.monthly are configured"
description: "Verify /etc/cron.monthly ownership and permissions are restricted to root with no group/other access"
