---
name: "CIS Ubuntu 14.04 LTS - 3.4.4 Ensure permissions on /etc/hosts.allow are configured"
description: "Verify that /etc/hosts.allow has correct ownership and permissions (root:root 644)"
