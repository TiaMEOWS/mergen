---
name: "CIS Ubuntu 14.04 LTS - 6.1.6 Ensure permissions on /etc/passwd- are configured"
description: "Verify /etc/passwd- has correct ownership (root:root) and permissions (644 or more restrictive)"
