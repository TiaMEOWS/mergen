...
export default function PrivacyPolicy() {
  ...
  return (
    <main data-page="legal">
      <Title>Mergen | Privacy Policy</Title>
      <LocaleLinks path="/legal/privacy-policy" />
      <Meta name="description" content="Mergen privacy policy" />
        ...
        <div data-component="content">
          <section data-component="brand-content">
            <article data-component="privacy-policy">
              ...
              <p>
                At Mergen, we take your privacy seriously. Please read this Privacy Policy to learn how we treat
                your personal data.{" "}
                <strong>
              ...
              <p>
                Remember that your use of Mergen is at all times subject to our Terms of Use,{" "}
                <a href={language.route("/legal/terms-of-service")}>https://mergen.dev/legal/terms-of-service</a>,
              ...
              <p>
                ...
                time. We will alert you of material changes by placing a notice on the Mergen website, by sending
              ...
              <ul>
                <li>
                  ...
                  sending you information about Mergen.
                </li>
              ...
              <p>
                ...
                you, Mergen or another party; enforcing any agreements with you; responding to claims that any
