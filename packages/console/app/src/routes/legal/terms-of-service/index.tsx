...
export default function TermsOfService() {
  ...
  return (
    <main data-page="legal">
      <Title>Mergen | Terms of Service</Title>
      <LocaleLinks path="/legal/terms-of-service" />
      <Meta name="description" content="Mergen terms of service" />
        ...
        <div data-component="content">
          <section data-component="brand-content">
            <article data-component="terms-of-service">
              ...
              <p>
                Welcome to Mergen. Please read on to learn the rules and restrictions that govern your use of
                Mergen (the "Services"). If you have any questions, comments, or concerns regarding these terms or
              ...
              <p>
                ...
                <strong>ANOMALY INNOVATIONS, INC.</strong> ("Mergen," "we" and "us"). Your use of the Services in
                ...
                <a href={language.route("/legal/privacy-policy")}>https://mergen.dev/legal/privacy-policy</a>.{" "}
                <strong>
              ...
              <h2 id="what-is-mergen">What is Mergen?</h2>
              <p>
                Mergen is an AI-powered coding agent that helps you write, understand, and modify code using large
                language models. Certain of these large language models are provided by third parties ("Third Party
                Models") and certain of these models are provided directly by us if you use the Mergen Zen paid
                offering ("Zen"). Regardless of whether you use Third Party Models or Zen, Mergen enables you to
              ...
              <p>
                ...
                our site located at mergen.dev, send you an email, and/or notify you by some other means.
              </p>
              ...
              <p>
                Mergen takes the privacy of its users very seriously. For the current Mergen Privacy Policy,
                please click here{" "}
                <a href="https://mergen.dev/legal/privacy-policy">https://mergen.dev/legal/privacy-policy</a>.
              </p>
              ...
              <h2 id="what-are-the-basics">What are the basics of using Mergen?</h2>
              <p>
              ...
              <ol style="list-style-type: lower-alpha;">
                ...
                <li>
                  ...
                  privacy laws or any other purpose not reasonably intended by Mergen;
                </li>
                <li>
              ...
              <p>
                If you use Mergen with Third Party Models, then your Content will be subject to the data retention
              ...
              <p>
                ...
                Mergen. Your ability to access Third Party Models is contingent on you having API keys or otherwise
                having the right to access such Third Party Models.
              </p>

              <p>
                Mergen has no control over, and assumes no responsibility for, the content, accuracy, privacy
              ...
              <h2 id="will-mergen-ever-change-the-services">Will Mergen ever change the Services?</h2>
              <p>
              ...
              <p>
                ...
                <a href={language.route("/zen")}>https://mergen.dev/zen</a> for a description of the current Paid
              ...
              <p>
                ...
                <a href="https://mergen.dev/auth">https://mergen.dev/auth</a>.
              </p>
              ...
              <p>
                ...
                <a href={language.route("/legal/privacy-policy")}>https://mergen.dev/legal/privacy-policy</a>, as
              ...
              <p>
                Mergen is also free to terminate (or suspend access to) your use of the Services for any reason in
                our discretion, including your breach of these Terms. Mergen has the sole right to decide whether
              ...
              <p>
                Mergen and its licensors, suppliers, partners, parent, subsidiaries or affiliated entities, and
                each of their respective officers, directors, members, employees, consultants, contract employees,
                representatives and agents, and each of their respective successors and assigns (Mergen and all
                such parties together, the "Mergen Parties") make no representations or warranties concerning the
                Services, including without limitation regarding any Content contained in or accessed through the
                Services, and the Mergen Parties will not be responsible or liable for the accuracy, copyright
                ...
                any way related to your participation in, the Services. The Mergen Parties make no representations
                or warranties regarding suggestions or recommendations of services or products offered or purchased
                through or in connection with the Services. THE SERVICES AND CONTENT ARE PROVIDED BY MERGEN (AND
              ...
              <p>
                ...
                MERGEN PARTIES BE LIABLE TO YOU OR TO ANY OTHER PERSON FOR (A) ANY INDIRECT, SPECIAL, INCIDENTAL,
                ...
                TO MERGEN IN CONNECTION WITH THE SERVICES IN THE TWELVE (12) MONTH PERIOD PRECEDING THIS APPLICABLE
              ...
              <h3>Indemnity</h3>
              <p>
                You agree to indemnify and hold the Mergen Parties harmless from and against any and all claims,
              ...
              <p>
                ...
                Services account, in any way (by operation of law or otherwise) without Mergen's prior written
              ...
              <p>
                ...
                disputes and claims with Mergen and limits the manner in which you can seek relief from
                Mergen. Both you and Mergen acknowledge and agree that for the purposes of any dispute arising
                out of or relating to the subject matter of these Terms, Mergen's officers, directors, employees
              ...
              <p>
                The Rules will govern payment of all arbitration fees. Mergen will pay all arbitration fees for
                claims less than seventy-five thousand ($75,000) dollars. Mergen will not seek its attorneys' fees
              ...
              <p>
                Either you or Mergen may assert claims, if they qualify, in small claims court in New Castle
              ...
              <p>
                YOU AND MERGEN WAIVE ANY CONSTITUTIONAL AND STATUTORY RIGHTS TO GO TO COURT AND HAVE A TRIAL IN
                FRONT OF A JUDGE OR JURY. You and Mergen are instead choosing to have claims and disputes resolved
                ...
                you and Mergen over whether to vacate or enforce an arbitration award, YOU AND MERGEN WAIVE
              ...
              <p>
                ...
                Mergen is entitled to arbitration; instead all claims and disputes will be resolved in a court as
              ...
              <p>
                ...
                agreement permits either you or Mergen to litigate any dispute arising out of or relating to the
                subject matter of these Terms in court, then the foregoing arbitration agreement will not apply to
                either party, and both you and Mergen agree that any judicial proceeding (other than small claims
              ...
              <p>
                ...
                the Mergen may, in its sole discretion, do any of the foregoing on your behalf or for itself as it
                ...
                Terms shall otherwise remain in full force and effect and enforceable. You and Mergen agree that
                these Terms are the complete and exclusive statement of the mutual understanding between you and
                Mergen, and that these Terms supersede and cancel all previous written and oral agreements,
                communications and other understandings relating to the subject matter of these Terms. You hereby
                acknowledge and agree that you are not an employee, agent, partner, or joint venture of Mergen, and
                you do not have any authority of any kind to bind Mergen in any respect whatsoever.
              </p>

              <p>
                Except as expressly set forth in the section above regarding the arbitration agreement, you and
                Mergen agree there are no third-party beneficiaries intended under these Terms.
              </p>
            </article>
          </section>
        </div>
