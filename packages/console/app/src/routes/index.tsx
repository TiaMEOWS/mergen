...
import video from "../asset/lander/mergen-min.mp4"
import videoPoster from "../asset/lander/mergen-poster.png"
                  ...
                  <Tabs.Content as="pre" data-slot="panel" value="npm">
                    <button data-copy data-slot="command" onClick={handleCopyClick}>
                      <span>
                        ...
                        <span data-slot="highlight">mergen</span>
                      </span>
                      <CopyStatus />
                    </button>
                  </Tabs.Content>
                  ...
                  <Tabs.Content as="pre" data-slot="panel" value="brew">
                    <button data-copy data-slot="command" onClick={handleCopyClick}>
                      <span>
                        ...
                        <span data-slot="highlight">TiaMEOWS/tap/mergen</span>
                      </span>
                      <CopyStatus />
                    </button>
                  </Tabs.Content>
