...
import compareVideo from "../../asset/lander/mergen-comparison-min.mp4"
import compareVideoPoster from "../../asset/lander/mergen-comparison-poster.png"
...
export default function Home() {
  ...
  return (
    <main data-page="zen">
      ...
      <Meta name="mergen:auth" content={loggedin() ? "true" : "false"} />
