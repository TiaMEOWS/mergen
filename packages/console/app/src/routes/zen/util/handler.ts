...
import { and, Database, eq, isNull, lt, or, sql } from "@mergen-io/console-core/drizzle/index.js"
import { KeyTable } from "@mergen-io/console-core/schema/key.sql.js"
import { BillingTable, SubscriptionTable, UsageTable } from "@mergen-io/console-core/schema/billing.sql.js"
import { centsToMicroCents } from "@mergen-io/console-core/util/price.js"
import { getWeekBounds } from "@mergen-io/console-core/util/date.js"
import { Identifier } from "@mergen-io/console-core/identifier.js"
import { Billing } from "@mergen-io/console-core/billing.js"
import { Actor } from "@mergen-io/console-core/actor.js"
import { WorkspaceTable } from "@mergen-io/console-core/schema/workspace.sql.js"
import { ZenData } from "@mergen-io/console-core/model.js"
import { Black, BlackData } from "@mergen-io/console-core/black.js"
import { UserTable } from "@mergen-io/console-core/schema/user.sql.js"
import { ModelTable } from "@mergen-io/console-core/schema/model.sql.js"
import { ProviderTable } from "@mergen-io/console-core/schema/provider.sql.js"
...
export async function handler(
  ...
  const FREE_WORKSPACES = [
    ...
    "wrk_01K6W1A3VE0KMNVSCQT43BG2SX", // mergen bench
  ]
  ...
  try {
    ...
    const sessionId = input.request.headers.get("x-mergen-session") ?? ""
    const requestId = input.request.headers.get("x-mergen-request") ?? ""
    const projectId = input.request.headers.get("x-mergen-project") ?? ""
    const ocClient = input.request.headers.get("x-mergen-client") ?? ""
    logger.metric({
      is_tream: isStream,
      session: sessionId,
      request: requestId,
    ...
    const retriableRequest = async (retry: RetryOptions = { excludeProviders: [], retryCount: 0 }) => {
      ...
      const res = await fetchWith429Retry(reqUrl, {
        ...
        headers: (() => {
          ...
          headers.delete("x-mergen-request")
          headers.delete("x-mergen-session")
          headers.delete("x-mergen-project")
          headers.delete("x-mergen-client")
          return headers
        })(),
        body: reqBody,
      })
  ...
  function validateBilling(authInfo: AuthInfo, modelInfo: ModelInfo): BillingSource {
    ...
    if (!billing.paymentMethodID)
      throw new CreditsError(
        `No payment method. Add a payment method here: https://mergen.dev/workspace/${authInfo.workspaceID}/billing`,
      )
    if (billing.balance <= 0)
      throw new CreditsError(
        `Insufficient balance. Manage your billing here: https://mergen.dev/workspace/${authInfo.workspaceID}/billing`,
      )
    ...
    if (
      ...
      throw new MonthlyLimitError(
        `Your workspace has reached its monthly spending limit of $${billing.monthlyLimit}. Manage your limits here: https://mergen.dev/workspace/${authInfo.workspaceID}/billing`,
      )
    ...
    if (
      ...
      throw new UserLimitError(
        `You have reached your monthly spending limit of $${authInfo.user.monthlyLimit}. Manage your limits here: https://mergen.dev/workspace/${authInfo.workspaceID}/members`,
      )
