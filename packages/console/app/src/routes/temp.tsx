    ...
    <main data-page="home">
      ...
      <div data-component="content">
        <section data-component="top">
          <img data-slot="logo light" src={logoLight} alt="mergen logo light" />
          <img data-slot="logo dark" src={logoDark} alt="mergen logo dark" />
          ...
          <div data-slot="right">
            <button data-copy data-slot="command">
              <span>
                ...
                <span data-slot="highlight">mergen.dev/install</span>
                <span> | bash</span>
              </span>
              <CopyStatus />
            </button>
        ...
        <section data-component="install">
          <div data-component="method">
            ...
            <button data-copy data-slot="button">
              <span>
                npm install -g <strong>@mergen-io/mergen@latest</strong>
              </span>
              <CopyStatus />
            </button>
          </div>
          <div data-component="method">
            ...
            <button data-copy data-slot="button">
              <span>
                bun install -g <strong>@mergen-io/mergen@latest</strong>
              </span>
              <CopyStatus />
            </button>
          </div>
          <div data-component="method">
            ...
            <button data-copy data-slot="button">
              <span>
                brew install <strong>mergen</strong>
              </span>
              <CopyStatus />
            </button>
          </div>
          <div data-component="method">
            ...
            <button data-copy data-slot="button">
              <span>
                paru -S <strong>mergen-bin</strong>
              </span>
              <CopyStatus />
            </button>
          </div>
        ...
        <footer data-component="footer">
          <div data-slot="cell">
            <a href="https://x.com/mergen">{i18n.t("footer.x")}</a>
          </div>
          <div data-slot="cell">
            <a href="https://github.com/TiaMEOWS/mergen">{i18n.t("footer.github")}</a>
          </div>
          <div data-slot="cell">
            <a href="https://mergen.dev/discord">{i18n.t("footer.discord")}</a>
          </div>
        </footer>
      </div>
