...
import desktopAppIcon from "../../asset/lander/mergen-desktop-icon.png"
      ...
      <div data-component="container">
        ...
        <div data-component="content">
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button
                ...
                onClick={handleCopyClick("curl -fsSL https://mergen.dev/install | bash")}
              >
                <code>
                  curl -fsSL https://<strong>mergen.dev/install</strong> | bash
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("npm i -g @mergen-io/mergen")}>
                <code>
                  npm i -g <strong>@mergen-io/mergen</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("bun add -g @mergen-io/mergen")}>
                <code>
                  bun add -g <strong>@mergen-io/mergen</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("brew install TiaMEOWS/tap/mergen")}>
                <code>
                  brew install <strong>TiaMEOWS/tap/mergen</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("paru -S mergen")}>
                <code>
                  paru -S <strong>mergen</strong>
                </code>
                <CopyStatus />
              </button>
            </div>
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button data-component="cli-row" onClick={handleCopyClick("brew install --cask mergen-desktop")}>
                <code>
                  brew install --cask <strong>mergen-desktop</strong>
                </code>
                <CopyStatus />
              </button>
