...
export function SessionHeader() {
  ...
  const leftMount = createMemo(
    () =>
      document.getElementById("mergen-titlebar-left") ?? document.getElementById("mergen-titlebar-center"),
  )
  const rightMount = createMemo(() => document.getElementById("mergen-titlebar-right"))
