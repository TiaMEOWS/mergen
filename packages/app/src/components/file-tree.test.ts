...
beforeAll(async () => {
  ...
  mock.module("@mergen-io/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@mergen-io/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@mergen-io/ui/icon", () => ({ Icon: () => null }))
  mock.module("@mergen-io/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
