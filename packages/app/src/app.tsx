...
import { Font } from "@mergen-io/ui/font"
import { MarkedProvider } from "@mergen-io/ui/context/marked"
import { DiffComponentProvider } from "@mergen-io/ui/context/diff"
import { CodeComponentProvider } from "@mergen-io/ui/context/code"
import { I18nProvider } from "@mergen-io/ui/context"
import { Diff } from "@mergen-io/ui/diff"
import { Code } from "@mergen-io/ui/code"
import { ThemeProvider } from "@mergen-io/ui/theme"
...
import { DialogProvider } from "@mergen-io/ui/context/dialog"
...
declare global {
  interface Window {
    __MERGEN__?: { updaterEnabled?: boolean; serverPassword?: string; deepLinks?: string[]; wsl?: boolean }
  }
}
...
const resolveDefaultServerUrl = (props: {
  ...
  if (props.hostname === "mergen.dev" || props.hostname.endsWith(".mergen.dev")) return ""
...
export function AppInterface(props: { defaultUrl?: string; children?: JSX.Element; isSidecar?: boolean }) {
  ...
  const isHub =
    !props.defaultUrl &&
    !props.isSidecar &&
    (location.hostname === "mergen.dev" || location.hostname.endsWith(".mergen.dev"))
  if (isHub) console.info("[mergen] hub mode:", location.hostname)
  const defaultServerUrl = resolveDefaultServerUrl({
    ...
    devHost: import.meta.env.VITE_MERGEN_SERVER_HOST,
    devPort: import.meta.env.VITE_MERGEN_SERVER_PORT,
  })
