...
import { Avatar } from "@mergen-io/ui/avatar"
import { DiffChanges } from "@mergen-io/ui/diff-changes"
import { HoverCard } from "@mergen-io/ui/hover-card"
...
import { Tooltip } from "@mergen-io/ui/tooltip"
import { getFilename } from "@mergen-io/util/path"
import { type Message, type Session, type TextPart, type UserMessage } from "@mergen-io/sdk/v2/client"
import { For, Match, Show, Switch, createMemo, onCleanup, type Accessor, type JSX } from "solid-js"
import { agentColor } from "@/utils/agent"

const MERGEN_PROJECT_ID = "4b0ea68d7af9a6031a7ffda7ad66e0cb83315750"
    ...
    <div class={`relative size-8 shrink-0 rounded ${props.class ?? ""}`}>
      <div class="size-full rounded overflow-clip">
        <Avatar
          fallback={name()}
          src={
            props.project.id === MERGEN_PROJECT_ID
              ? "https://mergen.dev/favicon.svg"
