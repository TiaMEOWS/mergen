...
import { base64Encode } from "@mergen-io/util/encode"
import { decode64 } from "@/utils/base64"
import { ResizeHandle } from "@mergen-io/ui/resize-handle"
import { Button } from "@mergen-io/ui/button"
import { Icon } from "@mergen-io/ui/icon"
import { IconButton } from "@mergen-io/ui/icon-button"
import { Tooltip, TooltipKeybind } from "@mergen-io/ui/tooltip"
import { DropdownMenu } from "@mergen-io/ui/dropdown-menu"
import { Dialog } from "@mergen-io/ui/dialog"
import { getFilename } from "@mergen-io/util/path"
import { Session, type Message } from "@mergen-io/sdk/v2/client"
...
import { showToast, Toast, toaster } from "@mergen-io/ui/toast"
import { useGlobalSDK } from "@/context/global-sdk"
import { clearWorkspaceTerminals } from "@/context/terminal"
import { useNotification } from "@/context/notification"
import { usePermission } from "@/context/permission"
import { Binary } from "@mergen-io/util/binary"
import { retry } from "@mergen-io/util/retry"
import { playSound, soundSrc } from "@/utils/sound"
import { createAim } from "@/utils/aim"
import { Worktree as WorktreeState } from "@/utils/worktree"

import { useDialog } from "@mergen-io/ui/context/dialog"
import { useTheme, type ColorScheme } from "@mergen-io/ui/theme"
  ...
  const useUpdatePolling = () =>
    onMount(() => {
      ...
      const pollUpdate = () => {
        ...
        if (s.http.password) headers["Authorization"] = basicAuth(s.http.username ?? "mergen", s.http.password!)
        ...
        >
          <div class="@container w-full h-full contain-strict">
            <SidebarContent
              ...
              onOpenHelp={() => platform.openLink("https://mergen.dev/desktop-feedback")}
