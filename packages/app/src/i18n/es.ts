export const dict = {
  ...
  "dialog.provider.mergen.note": "Modelos seleccionados incluyendo Claude, GPT, Gemini y más",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por Mergen",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en Mergen.",
  ...
  "provider.connect.mergenZen.line1":
    "Mergen Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  "provider.connect.mergenZen.line2":
    "Con una sola clave API obtendrás acceso a modelos como Claude, GPT, Gemini, GLM y más.",
  "provider.connect.mergenZen.visit.prefix": "Visita ",
  "provider.connect.mergenZen.visit.link": "mergen.dev/zen",
  "provider.connect.mergenZen.visit.suffix": " para obtener tu clave API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "este enlace",
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en Mergen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en Mergen.",
  ...
  "dialog.plugins.empty": "Plugins configurados en mergen.json",
  ...
  "dialog.server.description": "Cambiar a qué servidor de Mergen se conecta esta app.",
  ...
  "toast.update.description": "Una nueva versión de Mergen ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de Mergen",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (mergen.json)",
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, Mergen no soporta autenticación MCP todavía.',
  ...
  "sidebar.gettingStarted.line1": "Mergen incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor Mergen dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para Mergen",
  "settings.general.row.appearance.title": "Apariencia",
  "settings.general.row.appearance.description": "Personaliza cómo se ve Mergen en tu dispositivo",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de Mergen.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia Mergen",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de Mergen.",
