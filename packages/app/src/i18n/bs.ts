export const dict = {
  ...
  "dialog.provider.mergen.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje Mergen",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u Mergen-u.",
  ...
  "provider.connect.mergenZen.line1":
    "Mergen Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  "provider.connect.mergenZen.line2":
    "Sa jednim API ključem dobijaš pristup modelima kao što su Claude, GPT, Gemini, GLM i drugi.",
  "provider.connect.mergenZen.visit.prefix": "Posjeti ",
  "provider.connect.mergenZen.visit.link": "mergen.dev/zen",
  "provider.connect.mergenZen.visit.suffix": " da preuzmeš svoj API ključ.",
  "provider.connect.oauth.code.visit.prefix": "Posjeti ",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u Mergen-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u Mergen-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u mergen.json",
  ...
  "dialog.server.description": "Promijeni na koji se Mergen server ova aplikacija povezuje.",
  ...
  "toast.update.description": "Nova verzija Mergen-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku Mergen timu",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (mergen.json) provider/model names",
  "error.chain.mcpFailed":
    'MCP server "{{name}}" nije uspio. Napomena: Mergen još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "Mergen uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni Mergen server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u Mergen-u",
  "settings.general.row.appearance.title": "Izgled",
  "settings.general.row.appearance.description": "Prilagodi kako Mergen izgleda na tvom uređaju",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu Mergen-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se Mergen pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju Mergen-a.",
