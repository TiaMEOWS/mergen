export const dict = {
  ...
  "dialog.provider.mergen.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo Mergen",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no Mergen.",
  ...
  "provider.connect.mergenZen.line1":
    "Mergen Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  "provider.connect.mergenZen.line2":
    "Com uma única chave de API você terá acesso a modelos como Claude, GPT, Gemini, GLM e mais.",
  "provider.connect.mergenZen.visit.prefix": "Visite ",
  "provider.connect.mergenZen.visit.link": "mergen.dev/zen",
  "provider.connect.mergenZen.visit.suffix": " para obter sua chave de API.",
  "provider.connect.oauth.code.visit.prefix": "Visite ",
  "provider.connect.oauth.code.visit.link": "este link",
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no Mergen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no Mergen.",
  ...
  "dialog.plugins.empty": "Plugins configurados em mergen.json",
  ...
  "dialog.server.description": "Trocar para qual servidor Mergen este aplicativo se conecta.",
  ...
  "toast.update.description": "Uma nova versão do Mergen ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do Mergen",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (mergen.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: Mergen ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "Mergen inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor Mergen dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do Mergen",
  "settings.general.row.appearance.title": "Aparência",
  "settings.general.row.appearance.description": "Personalize como o Mergen aparece no seu dispositivo",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o Mergen é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o Mergen iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do Mergen.",
