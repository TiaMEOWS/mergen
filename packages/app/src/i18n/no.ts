...
export const dict = {
  ...
  "dialog.provider.mergen.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av Mergen",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i Mergen.",
  ...
  "provider.connect.mergenZen.line1":
    "Mergen Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  "provider.connect.mergenZen.line2":
    "Med én enkelt API-nøkkel får du tilgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.mergenZen.visit.prefix": "Besøk ",
  "provider.connect.mergenZen.visit.link": "mergen.dev/zen",
  "provider.connect.mergenZen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i Mergen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i Mergen.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i mergen.json",
  ...
  "dialog.server.description": "Bytt hvilken Mergen-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av Mergen ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til Mergen-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (mergen.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at Mergen ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "Mergen inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør Mergen-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for Mergen",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan Mergen ser ut på enheten din",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan Mergen er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når Mergen starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av Mergen.",
