export const dict = {
  ...
  "dialog.provider.mergen.note": "Modèles sélectionnés incluant Claude, GPT, Gemini et plus",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par Mergen",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans Mergen.",
  ...
  "provider.connect.mergenZen.line1":
    "Mergen Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.mergenZen.visit.prefix": "Visitez ",
  "provider.connect.mergenZen.visit.link": "mergen.dev/zen",
  "provider.connect.mergenZen.visit.suffix": " pour récupérer votre clé API.",
  "provider.connect.oauth.code.visit.prefix": "Visitez ",
  "provider.connect.oauth.code.visit.link": "ce lien",
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans Mergen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans Mergen.",
  ...
  "dialog.plugins.empty": "Plugins configurés dans mergen.json",
  ...
  "dialog.server.description": "Changez le serveur Mergen auquel cette application se connecte.",
  ...
  "toast.update.description":
    "Une nouvelle version d'Mergen ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe Mergen",
  ...
  "error.chain.checkConfig": "Vérifiez votre configuration (mergen.json) pour les noms de fournisseur/modèle",
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'Mergen ne supporte pas encore l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "Mergen inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur Mergen dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour Mergen",
  "settings.general.row.appearance.title": "Apparence",
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'Mergen sur votre appareil",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'Mergen.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'Mergen",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'Mergen.",
