export const dict = {
  ...
  "dialog.provider.mergen.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez Mergen",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w Mergen.",
  ...
  "provider.connect.mergenZen.line1":
    "Mergen Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  "provider.connect.mergenZen.line2":
    "Z jednym kluczem API uzyskasz dostęp do modeli takich jak Claude, GPT, Gemini, GLM i więcej.",
  "provider.connect.mergenZen.visit.prefix": "Odwiedź ",
  "provider.connect.mergenZen.visit.link": "mergen.dev/zen",
  "provider.connect.mergenZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w Mergen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w Mergen.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w mergen.json",
  ...
  "dialog.server.description": "Przełącz serwer Mergen, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja Mergen ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu Mergen",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (mergen.json) nazwy dostawców/modeli",
  ...
  "sidebar.gettingStarted.line1": "Mergen zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla Mergen",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd Mergen na swoim urządzeniu",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw Mergen.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania Mergen",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji Mergen.",
