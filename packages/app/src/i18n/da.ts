export const dict = {
  ...
  "dialog.provider.mergen.note": "Udvalgte modeller inklusive Claude, GPT, Gemini og flere",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af Mergen",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i Mergen.",
  ...
  "provider.connect.mergenZen.line1":
    "Mergen Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  "provider.connect.mergenZen.line2":
    "Med en enkelt API-nøgle får du adgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.mergenZen.visit.prefix": "Besøg ",
  "provider.connect.mergenZen.visit.link": "mergen.dev/zen",
  "provider.connect.mergenZen.visit.suffix": " for at hente din API-nøgle.",
  "provider.connect.oauth.code.visit.prefix": "Besøg ",
  "provider.connect.oauth.code.visit.link": "dette link",
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i Mergen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i Mergen.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i mergen.json",
  ...
  "dialog.server.description": "Skift hvilken Mergen-server denne app forbinder til.",
  ...
  "toast.update.description": "En ny version af Mergen ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til Mergen-teamet",
  ...
  "error.chain.checkConfig": "Tjek dine konfigurations (mergen.json) udbyder/modelnavne",
  "error.chain.mcpFailed":
    'MCP-server "{{name}}" fejlede. Bemærk, Mergen understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "Mergen inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør Mergen-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for Mergen",
  "settings.general.row.appearance.title": "Udseende",
  "settings.general.row.appearance.description": "Tilpas hvordan Mergen ser ud på din enhed",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan Mergen er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når Mergen starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af Mergen.",
