...
function setDevStats(value: {
  ...
  ;(globalThis as { __MERGEN_GLOBAL_SYNC_STATS?: typeof value }).__MERGEN_GLOBAL_SYNC_STATS = value
}
...
function createGlobalSync() {
  ...
  const sdkCache = new Map<string, ReturnType<typeof createMergenClient>>()
