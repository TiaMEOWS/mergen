...
/**
 * Server configuration for mergen serve and web commands
 */
export type ServerConfig = {
  ...
  mdns?: boolean
  /**
   * Custom domain name for mDNS service (default: mergen.local)
   */
  mdnsDomain?: string
  /**
...
export type Config = {
  ...
  server?: ServerConfig
  /**
   * Command configuration, see https://mergen.dev/docs/commands
   */
  command?: {
    [key: string]: {
      template: string
  ...
  /**
   * Agent configuration, see https://mergen.dev/docs/agents
   */
  agent?: {
    mergen?: AgentConfig
    general?: AgentConfig
