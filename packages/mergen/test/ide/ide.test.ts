...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders MERGEN_CALLER", () => {
    process.env["MERGEN_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode MERGEN_CALLER", () => {
    process.env["MERGEN_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown MERGEN_CALLER", () => {
    process.env["MERGEN_CALLER"] = "unknown"
