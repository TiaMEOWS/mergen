...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/mergen.git")).toEqual({ owner: "sst", repo: "mergen" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/mergen")).toEqual({ owner: "sst", repo: "mergen" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/mergen.git")).toEqual({ owner: "sst", repo: "mergen" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/mergen")).toEqual({ owner: "sst", repo: "mergen" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/mergen.git")).toEqual({ owner: "sst", repo: "mergen" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/mergen")).toEqual({ owner: "sst", repo: "mergen" })
})
