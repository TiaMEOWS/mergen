...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Mergen Dependency Scanner - Scan running processes for loaded shared libraries and known vulnerabilities",
...
def print_text_output(results, vuln_check=False):
    ...
    print("=" * 90)
    print(f"{'Mergen Dependency Scanner':^90}")
    print("=" * 90)
    print()
