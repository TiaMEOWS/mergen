...
export const GlobalRoutes = lazy(() =>
  new Hono()
    .get(
      ...
      describeRoute({
        summary: "Get health",
        description: "Get health information about the Mergen server.",
    ...
    .get(
      ...
      describeRoute({
        ...
        description: "Check if a newer version of Mergen is available.",
    ...
    .get(
      ...
      describeRoute({
        ...
        description: "Subscribe to global events from the Mergen system using server-sent events.",
    ...
    .get(
      ...
      describeRoute({
        ...
        description: "Retrieve the current global Mergen configuration settings and preferences.",
    ...
    .patch(
      ...
      describeRoute({
        ...
        description: "Update global Mergen configuration settings and preferences.",
    ...
    .post(
      ...
      describeRoute({
        ...
        description: "Clean up and dispose all Mergen instances, releasing all resources.",
