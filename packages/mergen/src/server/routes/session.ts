  ...
  new Hono()
    .get(
      ...
      describeRoute({
        ...
        description: "Get a list of all Mergen sessions, sorted by most recently updated.",
    ...
    .get(
      ...
      describeRoute({
        summary: "Get session",
        description: "Retrieve detailed information about a specific Mergen session.",
        tags: ["Session"],
    ...
    .post(
      ...
      describeRoute({
        ...
        description: "Create a new Mergen session for interacting with AI assistants and managing conversations.",
    ...
    .post(
      ...
      async (c) => {
        ...
        const ingestDryRun = process.env.MERGEN_INGEST_DRY_RUN === "true"
