    ...
    () =>
      ...
      app
        ...
        .use(
          cors({
            origin(input) {
              ...
              // *.mergen.dev (https only)
              if (/^https:\/\/([a-z0-9-]+\.)*mergen\.io$/.test(input)) {
                return input
              }
            ...
            credentials: true,
            allowHeaders: ["Authorization", "Content-Type", "x-mergen-directory"],
          }),
        )
        .use(async (c, next) => {
          if (c.req.method === "OPTIONS") return next()
          const password = Flag.MERGEN_SERVER_PASSWORD
          ...
          const username = Flag.MERGEN_SERVER_USERNAME ?? "mergen"
        ...
        .use(async (c, next) => {
          ...
          const explicit = c.req.query("directory") || c.req.header("x-mergen-directory")
        ...
        .post(
          ...
          describeRoute({
            ...
            description: "Clean up and dispose the current Mergen instance, releasing all resources.",
        ...
        .get(
          ...
          describeRoute({
            summary: "Get paths",
            description:
              "Retrieve the current working directory and related path information for the Mergen instance.",
        ...
        .get(
          ...
          describeRoute({
            ...
            description: "Get a list of all available commands in the Mergen system.",
        ...
        .get(
          ...
          describeRoute({
            summary: "List agents",
            description: "Get a list of all available AI agents in the Mergen system.",
        ...
        .all("/*", async (c) => {
          ...
          if (_webDistDir === undefined) {
            const candidates = [
              // 1. ~/.mergen/web/ (installed/production)
