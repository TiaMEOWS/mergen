...
export namespace ModelsDev {
  ...
  function url() {
    return Flag.MERGEN_MODELS_URL || "https://models.dev"
  }

  export const Data = lazy(async () => {
    const file = Bun.file(Flag.MERGEN_MODELS_PATH ?? filepath)
    ...
    if (Flag.MERGEN_DISABLE_MODELS_FETCH) return {}
...
if (!Flag.MERGEN_DISABLE_MODELS_FETCH && !process.argv.includes("--get-yargs-completions")) {
  ModelsDev.refresh()
  setInterval(
    async () => {
