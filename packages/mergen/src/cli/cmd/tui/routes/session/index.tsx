...
import type { AssistantMessage, Part, ToolPart, UserMessage, TextPart, ReasoningPart } from "@mergen-io/sdk/v2"
  ...
  createEffect(() => {
    ...
    return exit.message.set(
      [
        ...
        `  █   ▀▀█  ${UI.Style.TEXT_DIM}mergen -s ${session()?.id}${UI.Style.TEXT_NORMAL}`,
        `  ▀▀▀ ▀▀▀  `,
      ].join("\n"),
    )
  })
        ...
        dialog.replace(() => (
          <DialogReport
            ...
            onGenerate={() => {
              prompt.set({
                input:
                  "Generate final report with generate_report tool. Fill all AI sections and save to .mergen/reports/",
                parts: [],
              })
            }}
          />
  ...
  return (
    <Show when={props.part.text.trim()}>
      <box id={"text-" + props.part.id} paddingLeft={3} marginTop={1} flexShrink={0}>
        <Switch>
          <Match when={Flag.MERGEN_EXPERIMENTAL_MARKDOWN}>
            <markdown
              syntaxStyle={syntax()}
              streaming={true}
