...
export namespace SkillSigning {
  ...
  // Mergen official Ed25519 public key (base64-encoded raw 32-byte key)
  // Used to verify skills signed by the Mergen team.
  ...
  export async function verify(skill: {
    ...
    if (skill.signed_by !== "mergen-official" || !skill.signature) return "community"
