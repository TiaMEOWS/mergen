...
export namespace Skill {
  ...
  const MERGEN_SKILL_GLOB = new Bun.Glob("{skill,skills}/**/SKILL.md")
  ...
  export const state = Instance.state(async () => {
    ...
    if (!Flag.MERGEN_DISABLE_EXTERNAL_SKILLS) {
    ...
    // Scan .mergen/skill/ directories
    for (const dir of await Config.directories()) {
      for await (const match of MERGEN_SKILL_GLOB.scan({
        cwd: dir,
        absolute: true,
        onlyFiles: true,
        followSymlinks: true,
