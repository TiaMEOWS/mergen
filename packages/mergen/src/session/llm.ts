...
export namespace LLM {
  ...
  export async function stream(input: StreamInput) {
    ...
    return streamText({
      ...
      headers: {
        ...(input.model.providerID.startsWith("mergen")
          ? {
              "x-mergen-project": Instance.project.id,
              "x-mergen-session": input.sessionID,
              "x-mergen-request": input.user.id,
              "x-mergen-client": Flag.MERGEN_CLIENT,
            }
