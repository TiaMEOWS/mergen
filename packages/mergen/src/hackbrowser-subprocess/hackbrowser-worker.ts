#!/usr/bin/env node
// Hackbrowser worker — runs as a subprocess of the main mergen binary.
...
import { runCrawl } from "@mergen-io/hackbrowser/api"
import type { CrawlOptions, LogRecord, CSEvent } from "@mergen-io/hackbrowser/api"
