...
const PROGRAMS = {
  ...
  defender_exclude: {
    description:
      "Add exclusion paths to Windows Defender via PowerShell to prevent scanning of Mergen tools and payloads",
    args: "--path PATH",
  },
  cleanup_win: {
    description:
      "Remove Mergen artifacts — clear Security/System/Application event logs, remove scheduled tasks, restore AMSI/ETW patches, delete temp files. ALWAYS run before leaving a target",
    args: "",
  },
  ad_enum: {
    description:
