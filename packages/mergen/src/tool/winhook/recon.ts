  ...
  if (activeExec === "cmd" || activeExec === "bat" || activeExec === "wmic") {
    ...
    if (action === "software" || action === "full") {
      ...
      findings.push({
        ...
        details: `${names.length} apps found, ${found.length} interesting. Review application names and versions in the output — for any with a version, check CVE database via cve-mcp (cve search_by_product --product <name> --version <ver>). If cve-mcp is not enabled: mergen mcp enable cve`,
    ...
    if (action === "services" || action === "full") {
      ...
      findings.push({
        ...
        details:
          "Running services enumerated. Review service names and versions — for any with a version, check CVE database via cve-mcp (cve search_by_product --product <name> --version <ver>). If cve-mcp is not enabled: mergen mcp enable cve",
    ...
    if (action === "hotfixes" || action === "full") {
      ...
      findings.push({
        ...
        details:
          "OS version and installed hotfixes enumerated. Review OS build number and missing KBs — check CVE database via cve-mcp (cve search_by_product --product windows --version <build>) for known exploits. If cve-mcp is not enabled: mergen mcp enable cve",
...
`
    ...
    findings.push({
      ...
      details: `${r.stdout.substring(0, 400)} — Review application names and versions in the output — for any with a version, check CVE database via cve-mcp (cve search_by_product --product <name> --version <ver>). If cve-mcp is not enabled: mergen mcp enable cve`,
...
`
    ...
    findings.push({
      ...
      details: `${r.stdout.substring(0, 400)} — Review service names and versions — for any with a version, check CVE database via cve-mcp (cve search_by_product --product <name> --version <ver>). If cve-mcp is not enabled: mergen mcp enable cve`,
...
`
    ...
    findings.push({
      ...
      details: `${r.stdout.substring(0, 400)} — Review OS build and missing KBs — check CVE database via cve-mcp (cve search_by_product --product windows --version <build>) for known exploits. If cve-mcp is not enabled: mergen mcp enable cve`,
