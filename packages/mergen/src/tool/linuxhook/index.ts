...
const PROGRAMS = {
  ...
  cleanup_linux: {
    description:
      "Remove Mergen artifacts from Linux target — clear logs, remove persistence mechanisms, restore modified configs, clean temp files. ALWAYS run before leaving",
    args: "",
  },
  artifact_enum: {
    description:
