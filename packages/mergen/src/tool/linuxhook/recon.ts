...
`
  ...
  findings.push({
    ...
    details: `${running} running service references found. Review service names and versions in the output above — for any service with a version, check CVE database via cve-mcp (cve search_by_product --product <name> --version <ver>). If cve-mcp is not enabled: mergen mcp enable cve`,
