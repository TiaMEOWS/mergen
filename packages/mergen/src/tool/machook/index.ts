...
const PROGRAMS = {
  ...
  artifact_enum: {
    description: "Pre-cleanup audit — find all Mergen artifacts before cleanup",
    args: "",
  },
  cleanup_mac: {
    description:
      "Remove Mergen artifacts — LaunchAgents, processes, temp files, DTrace scripts, history. ALWAYS run before leaving",
    args: "",
  },
