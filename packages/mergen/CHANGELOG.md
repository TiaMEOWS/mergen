...
- `knowledge/` directory (migrated to `.mergen/skill/WEB/OWASP_WSTG_4.2/`)
...
**Full Changelog**: https://github.com/TiaMEOWS/mergen/compare/v1.1.9...v1.1.10
