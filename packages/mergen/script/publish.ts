...
const skillSrcPath = "../../.mergen/skill"
...
// Global.Path.bin (~/.local/share/mergen/bin/) so the main binary can
  ...
  JSON.stringify(
    {
      ...
      repository: {
        type: "git",
        url: "https://github.com/TiaMEOWS/mergen.git",
      },
      dependencies: {
...
const tasks = Object.entries(binaries).map(async ([name]) => {
  // name is scoped like "@mergen-io/mergen-darwin-arm64"
  // directory on disk is just "mergen-darwin-arm64"
