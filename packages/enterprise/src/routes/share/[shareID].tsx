import { FileDiff, Message, Model, Part, Session, SessionStatus, UserMessage } from "@mergen-io/sdk/v2"
import { SessionTurn } from "@mergen-io/ui/session-turn"
import { SessionReview } from "@mergen-io/ui/session-review"
import { DataProvider } from "@mergen-io/ui/context"
import { DiffComponentProvider } from "@mergen-io/ui/context/diff"
import { CodeComponentProvider } from "@mergen-io/ui/context/code"
import { WorkerPoolProvider } from "@mergen-io/ui/context/worker-pool"
import { createAsync, query, useParams } from "@solidjs/router"
import { createEffect, createMemo, ErrorBoundary, For, Match, Show, Switch } from "solid-js"
import { Share } from "~/core/share"
import { Logo, Mark } from "@mergen-io/ui/logo"
import { IconButton } from "@mergen-io/ui/icon-button"
import { ProviderIcon } from "@mergen-io/ui/provider-icon"
import { createDefaultOptions } from "@mergen-io/ui/pierre"
import { iife } from "@mergen-io/util/iife"
import { Binary } from "@mergen-io/util/binary"
import { NamedError } from "@mergen-io/util/error"
import { DateTime } from "luxon"
import { createStore } from "solid-js/store"
import z from "zod"
import NotFound from "../[...404]"
import { Tabs } from "@mergen-io/ui/tabs"
import { MessageNav } from "@mergen-io/ui/message-nav"
import { preloadMultiFileDiff, PreloadMultiFileDiffResult } from "@pierre/diffs/ssr"
import { Diff as SSRDiff } from "@mergen-io/ui/diff-ssr"
import { clientOnly } from "@solidjs/start"
import { type IconName } from "@mergen-io/ui/icons/provider"
import { Meta, Title } from "@solidjs/meta"
import { Base64 } from "js-base64"

const ClientOnlyDiff = clientOnly(() => import("@mergen-io/ui/diff").then((m) => ({ default: m.Diff })))
const ClientOnlyCode = clientOnly(() => import("@mergen-io/ui/code").then((m) => ({ default: m.Code })))
const ClientOnlyWorkerPoolProvider = clientOnly(() =>
  import("@mergen-io/ui/pierre/worker").then((m) => ({
      ...
      <Show when={data()}>
        {(data) => {
          ...
          const ogImage = createMemo(() => {
            ...
            return `https://social-cards.sst.dev/mergen-share/${encodedTitle}.png?model=${modelParam}&version=${version}&id=${data().shareID}`
          })

          return (
            <>
              <Show when={info().title}>
                <Title>{info().title} | Mergen</Title>
              </Show>
              <Meta name="description" content="mergen - The AI coding agent built for the terminal." />
                          ...
                          <div class="relative bg-background-stronger w-screen h-screen overflow-hidden flex flex-col">
                            <header class="h-12 px-6 py-2 flex items-center justify-between self-stretch bg-background-base border-b border-border-weak-base">
                              ...
                              <div class="flex gap-3 items-center">
                                <IconButton
                                  as={"a"}
                                  href="https://github.com/TiaMEOWS/mergen"
                                  target="_blank"
                                  icon="github"
                                  variant="ghost"
                                />
