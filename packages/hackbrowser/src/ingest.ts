...
export function initAuth(username?: string, password?: string): void {
  ...
  authHeader = btoa(`${username ?? "mergen"}:${password}`)
...
// ============================================================
// Send captured request to Mergen /session/ingest
// ============================================================
...
/** Register a credential with Mergen. Returns the credential ID. */
...
/** Sync credential auth headers with Mergen (PATCH). */
...
// ============================================================
// Page-diff: send element availability to Mergen (Aşama 12)
// ============================================================
