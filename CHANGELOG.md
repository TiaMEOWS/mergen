...
- Web UI bundled in npm package (auto-installs to `~/.mergen/web/`)
- MCP/Bolt status tabs in TUI status popover with config persistence

### Fixed

- CORS and auth failures on remote/tunnel access
- Enterprise infra made conditional on `MERGEN_ENTERPRISE` env var
...
- npm scope renamed `@mergenus` → `@mergen-io`
- All `mergen.us` → `mergen.dev`
- Bin launcher `opencode` → `mergen`
...
- Initial public release of Mergen
...
[1.1.16]: https://github.com/TiaMEOWS/mergen/releases/tag/v1.1.16
[1.1.15]: https://github.com/TiaMEOWS/mergen/releases/tag/v1.1.15
[1.1.6]: https://github.com/TiaMEOWS/mergen/releases/tag/v1.1.6
[1.1.4]: https://github.com/TiaMEOWS/mergen/releases/tag/v1.1.4
[1.1.0]: https://github.com/TiaMEOWS/mergen/releases/tag/v1.1.0
[1.0.8-beta.1]: https://github.com/TiaMEOWS/mergen/releases/tag/v1.0.8-beta.1
[0.1.0]: https://github.com/TiaMEOWS/mergen/releases/tag/v0.1.0
