...
We are committed to making Mergen an open, welcoming, and professional community for everyone interested in offensive security, penetration testing, and AI-powered security tools.
...
- **Be ethical.** Mergen is for authorized security testing only. Do not share techniques, exploits, or tools intended for unauthorized access.
...
Mergen is a security tool. We expect all community members to:
...
- Never use Mergen or its components for unauthorized access
...
- Contacting a maintainer on [Discord](https://mergen.dev/discord)
- Emailing **conduct@mergen.dev**
...
This code of conduct applies to all Mergen project spaces: GitHub repository, issues, pull requests, Discord, and any other community channels.
