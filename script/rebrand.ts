#!/usr/bin/env bun
/**
 * Mergen Rebrand Script
 *
 * Automates find-replace across the monorepo for the OpenCode → Mergen rebrand.
...
const REPLACEMENTS: [string, string][] = [
  ...
  ["@opencode-ai/", "@mergenus/"],
  ["opencode-ai", "mergen"],

  // GitHub references
  ["anomalyco/tap/opencode", "TiaMEOWS/tap/mergen"],
  ["anomalyco/opencode", "TiaMEOWS/mergen"],

  // Domain
  ["opencode.ai", "mergen.dev"],
  ["opncd.ai", "cybrstk.us"],

  // Desktop app identifier
  ["ai.opencode.desktop", "us.mergen.desktop"],
