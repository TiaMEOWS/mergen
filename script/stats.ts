...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/TiaMEOWS/mergen/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for TiaMEOWS/mergen...\n")
...
console.log("Fetching npm all-time downloads for mergen...\n")
const npmDownloads = await fetchNpmDownloads("mergen")
